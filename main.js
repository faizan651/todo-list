...
while (condition) {
    ...
    if (operationAns.operation === "Modify") {
        if (todos.length === 0) {
            ...
            let todoQuestions = await inquirer.prompt([
                {
                    name: "firstQuestion",
                    type: "input",
                    message: "What would you like to edit in your To-dos? Note: (To-do must be match with exisitng and case sensitive)",
                },
                {
                    name: "secondQuestion",
                    type: "input",
            ...
            let n = 0;
            while (n < todos.length) {
                if (todos[n] === todoQuestions.firstQuestion &&
            ...
            let todoQuestions = await inquirer.prompt([
                {
                    name: "firstQuestion",
                    type: "input",
                    message: "What would you like to delete in your To-dos? Note: (To-do must be match with existing and case sensitive)",
                },
            ]);
